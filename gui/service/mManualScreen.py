...
from core.variables_map import VARIABLES  # Versión productiva (sin mocks)
...
class mManualScr(QWidget):
    ...
    def _setup_timers(self):
        ...
        self._local_timers_state = {
            "op_pb": {"duration_ms": 0, "start_ms": 0, "active": False,
                      "elapsed_lbl": None, "remaining_lbl": None},
            "op_pd": {"duration_ms": 0, "start_ms": 0, "active": False,
                      "elapsed_lbl": None, "remaining_lbl": None},
            "op_puf": {"duration_ms": 0, "start_ms": 0, "active": False,
                      "elapsed_lbl": None, "remaining_lbl": None},
