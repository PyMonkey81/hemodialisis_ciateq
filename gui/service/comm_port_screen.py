...
#         super().__init__(parent)
#         self.setup_ui()
#         # Establecer configuraciones iniciales para que los comboboxes tengan valores por defecto
#         # Puedes cargar configuraciones guardadas aquí si existieran
#         self.cmb_cond_port.setCurrentText("Auto")
#         self.cmb_bioz_port.setCurrentText("Auto")
#         self.chk_cond.setChecked(False) # Por defecto deshabilitado si no hay sensores
#         self.chk_bioz.setChecked(False) # Por defecto deshabilitado si no hay sensores
...
#     def apply_configurations(self):
#         # Emitir señales con la nueva configuración
#         # El valor "Auto" se pasa directamente, y los controladores lo interpretarán como None para auto-detección
#         self.config_changed.emit("CONDUCTIVITY", self.cmb_cond_port.currentText(), self.chk_cond.isChecked())
#         self.config_changed.emit("BIOZ", self.cmb_bioz_port.currentText(), self.chk_bioz.isChecked())
...
#         # Buscar puertos disponibles en la PC
#         available_ports = [port.device for port in serial.tools.list_ports.comports()]
#         if not available_ports:
#             available_ports = ["Ninguno"]
...
#         self.chk_cond = QCheckBox("Habilitar Comunicación")
#         self.cmb_cond_port = QComboBox()
#         self.cmb_cond_port.addItems(available_ports)
...
#         self.chk_bioz = QCheckBox("Habilitar Comunicación")
#         self.cmb_bioz_port = QComboBox()
#         self.cmb_bioz_port.addItems(available_ports)
