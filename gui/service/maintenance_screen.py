...
#         self.pon_value = QLabel("00:00 hh:mm")
#         self.pon_value.setStyleSheet(value_style)
#         self.pon_value.setAlignment(Qt.AlignCenter)

#         pon_layout.addStretch()          # ← Espacio arriba
#         pon_layout.addWidget(lbl_pon)
#         pon_layout.addWidget(self.pon_value)
#         pon_layout.addStretch()          # ← Espacio abajo
...
#         self.op_value = QLabel("00:00 hh:mm")
#         self.op_value.setStyleSheet(value_style)
#         self.op_value.setAlignment(Qt.AlignCenter)
...
#         self.clean_value = QLabel("00:00 hh:mm")
#         self.clean_value.setStyleSheet(value_style)
#         self.clean_value.setAlignment(Qt.AlignCenter)
...
#     def update_power_on_hours(self, hours: int, minutes: int):
#         self.pon_value.setText(f"{hours:02d}:{minutes:02d} hh:mm")

#     def update_operation_hours(self, hours: int, minutes: int):
#         self.op_value.setText(f"{hours:02d}:{minutes:02d} hh:mm")

#     def update_cleaning_hours(self, hours: int, minutes: int):
#         self.clean_value.setText(f"{hours:02d}:{minutes:02d} hh:mm")
...
#                 self.pon_value.setText("00:00 hh:mm")
#                 logger.warning("Power On Hours fue reseteado por técnico")
...
#                 self.op_value.setText("00:00 hh:mm")
#                 logger.warning("Horas de Operación en Tratamiento fueron reseteadas por técnico")
...
#     def update_hours_display(self, power_on: float, operation: float, cleaning: float):
#         """Actualiza los displays de horas en tiempo real desde TimerManager"""
#         try:
#             # Power On Hours
#             po_h = int(power_on)
#             po_m = int((power_on - po_h) * 60)
#             if hasattr(self, 'power_on_label'):
#                 self.power_on_label.setText(f"{po_h:03d} h {po_m:02d} m")

#             # Operation Hours
#             op_h = int(operation)
#             op_m = int((operation - op_h) * 60)
#             if hasattr(self, 'operation_label'):
#                 self.operation_label.setText(f"{op_h:03d} h {op_m:02d} m")

#             # Cleaning Hours
#             cl_h = int(cleaning)
#             cl_m = int((cleaning - cl_h) * 60)
#             if hasattr(self, 'cleaning_label'):
#                 self.cleaning_label.setText(f"{cl_h:03d} h {cl_m:02d} m")

#             logger.debug(f"Horas actualizadas - Power: {po_h}h{po_m}m | Op: {op_h}h{op_m}m | Clean: {cl_h}h{cl_m}m")
