...
from hemodialisis_ciateq.core.alarms import AlarmSystem
from hemodialisis_ciateq.core.alarm_config_manager import AlarmConfigManager
from hemodialisis_ciateq.core.state_manager import AppStateManager, TreatmentPhase
from hemodialisis_ciateq.core.timer_manager import TimerManager
from hemodialisis_ciateq.core.treatment_controller import TreatmentController
from hemodialisis_ciateq.core.hardware_state_mapper import HardwareStateMapper
from hemodialisis_ciateq.core.variables_map import TAG_TO_ADDRESS, VARIABLES
from hemodialisis_ciateq.core.ktv.ktv_controller import KtvController
from hemodialisis_ciateq.connection.serial_communication import SerialCommunication
from hemodialisis_ciateq.connection.led_bar_controller import LedBarController
from hemodialisis_ciateq.connection.bioz_urea_controller import BiozUreaController
from hemodialisis_ciateq.connection.conductivity_sensor_comm import PatternConductivity

from hemodialisis_ciateq.gui.screen_state_manager import ScreenStateManager
from hemodialisis_ciateq.gui.therapy.main_screen import MainScreen
from hemodialisis_ciateq.gui.therapy.alarms_screen import AlarmsScreen
from hemodialisis_ciateq.gui.therapy.dialysis_screen import DialysisScreen
from hemodialisis_ciateq.gui.therapy.treatment_mode_screen import TreatmentModeScreen
from hemodialisis_ciateq.gui.therapy.ktv_screen import KTVScreen
from hemodialisis_ciateq.gui.service.options_screen import OptionsScreen
from hemodialisis_ciateq.gui.service.history_screen import HistoryScreen
from hemodialisis_ciateq.gui.service.cleaning_screen import CleaningScreen
from hemodialisis_ciateq.gui.service.comm_port_screen import CommPortScreen
from hemodialisis_ciateq.gui.components.real_time_variables import RealTimeVariablesMonitor
from hemodialisis_ciateq.gui.components.tank_gauge import TankGauge
from hemodialisis_ciateq.gui.components.conductivity_bar import ConductivityBar
from hemodialisis_ciateq.gui.components.floating_message import FloatingMessage

from hemodialisis_ciateq.gui.configuration.alarm_limits import AlarmLimitsManager
from hemodialisis_ciateq.gui.configuration.alarm_screen_config import AlarmScreenConfig 
from hemodialisis_ciateq.gui.configuration.alarm_screen_service_config import AlarmScreenServiceConfig
from hemodialisis_ciateq.gui.configuration.cleanning_config_screen import CleanningConfigScreen

from hemodialisis_ciateq.gui.service.manual_mode_screen import ManualModeScreen
from hemodialisis_ciateq.gui.service.test_panel_screen import TestPanelScreen
from hemodialisis_ciateq.gui.service.calibration_screen import CalibrationScreen
from hemodialisis_ciateq.gui.service.network_config_screen import NetworkConfigScreen
from hemodialisis_ciateq.gui.service.maintenance_screen import MaintenanceScreen

from hemodialisis_ciateq.gui.therapy.patient_config_screen import PatientConfigScreen
from hemodialisis_ciateq.gui.therapy.therapy_config_screen import TherapyConfigScreen

from hemodialisis_ciateq.logic.ktv_calculator import CalculadoraKtV
from hemodialisis_ciateq.logic.heitmann import heitmann
from hemodialisis_ciateq.logic.calculos import (
    convertir_flujo_a_ciclos, convertir_ciclos_a_flujo,
    convertir_litros_h_a_ml_min, convertir_ml_min_a_litros_h,
    calculo_ptm
)
from hemodialisis_ciateq.utilities.csv_logger import CsvLogger
...
def resource_path(relative_path):
    ...
    # In development, resolve from project root (parent of gui/).
