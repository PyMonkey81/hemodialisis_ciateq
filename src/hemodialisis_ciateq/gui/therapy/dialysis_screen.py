...
from hemodialisis_ciateq.gui.components.ui_components import LabeledParameterWidget, LabeledTimeInput
...
try:
    from hemodialisis_ciateq.logic.calculos import calculo_ptm
except ImportError:
