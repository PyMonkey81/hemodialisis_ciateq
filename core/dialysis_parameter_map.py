...
DIALYSIS_PARAMETERS: Dict[int, Dict[int, Dict[str, Any]]] = {
    ...
    0x03: {
        ...
        0x02: {"parameter_name": "Heparin Auto-Stop Duration (Hours)", "data_type": "double", "access_mode": True, "unit": "h", "alarm_limits": (0, 10), "device_tag": "heparinAutoStopHoursSetpoint", "priority": "Low"},                  # 9
        0x03: {"parameter_name": "Heparin Auto-Stop Duration (Minutes)", "data_type": "double", "access_mode": True, "unit": "min", "alarm_limits": (0, 59), "device_tag": "heparinAutoStopMinutesSetpoint", "priority": "Low"},             # 10
