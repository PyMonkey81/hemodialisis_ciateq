...
#     Args:
#         nombres (List[str]): Nombres de las alarmas.
...
#         on_alarma: Optional[Callable[..., None]] = None,
#         on_registro: Optional[Callable[..., None]] = None,
...
#         # === Listas completadas al tamaño correcto ===
...
#         self.ejecutando = False  # ← palabra más clara y común en español

#         self.iniciar_monitoreo()

#     @staticmethod
#     def _completar_lista(
#         lista: Optional[List[Any]],
#         valor_defecto: Any,
#         tamaño: int,
#     ) -> List[Any]:
#         """Completa una lista hasta alcanzar el tamaño deseado."""
#         if lista is None:
#             return [valor_defecto] * tamaño
#         if len(lista) >= tamaño:
#             return lista[:tamaño]
#         return lista + [valor_defecto] * (tamaño - len(lista))

#     def actualizar_valor(self, idx: int, valor: float) -> None:
#         """Actualiza el valor de una alarma específica (seguro para hilos)."""
#         if 0 <= idx < self.num_alarmas:
#             with self.bloqueo:
#                 self.valores[idx] = valor

#     def _monitoreo(self) -> None:
#         """Bucle principal de monitoreo (se ejecuta en hilo separado)."""
#         while self.ejecutando:  # ← ejecutando
#             with self.bloqueo:
...
#                 else:  # booleano
#                     condicion_activacion = (valor != 0)
#                     activada = (
#                         condicion_activacion
#                         if self.trigger_booleano[i]
#                         else not condicion_activacion
#                     )
...
#         """Inicia el hilo de monitoreo si aún no está ejecutando."""
...
#         # CRÍTICO: Anulamos la referencia al hilo después del join.
#         # Esto asegura que el recolector de basura lo libere inmediatamente.
#         self.hilo = None 
...
#         trigger_booleano: Optional[List[bool]] = None,
#     ) -> None:
#         """Reconfigura el sistema (puede cambiar número de alarmas)."""
#         with self.bloqueo:
...
#     def obtener_historial(self) -> List[Tuple[str, float, str]]:
#         """Devuelve una copia segura del historial de eventos."""
#         with self.bloqueo:
...
class SistemaAlarmas(QObject):
    ...
    def __init__(
        ...
        limites: Optional[List[Tuple[float, float]]] = None,
        niveles: Optional[List[str]] = None,
        # Ya no necesitamos on_alarma ni on_registro obligatorios aquí
        tipos: Optional[List[str]] = None,
        trigger_booleano: Optional[List[bool]] = None,
    ):
